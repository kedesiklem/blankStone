...
function OnPlayerSpawned(player_entity)
    ...
    -- EntityLoad( STONE_PATH .. "stone_copper.xml", pos_x, pos_y )
    -- EntityLoad( STONE_PATH .. "stone_brass.xml", pos_x, pos_y )
    ...
    -- EntityLoad( STONE_PATH .. "stone_mana.xml", pos_x, pos_y )
