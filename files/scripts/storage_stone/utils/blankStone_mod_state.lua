...
function BagsModState:new()
    ...
    obj.button_pos_x = get_mod_setting_number("blankStone.pos_x", 170)
    obj.button_pos_y = get_mod_setting_number("blankStone.pos_y", 40)
    obj.alchemy_pos_x = get_mod_setting_number("blankStone.alchemy_pos_x", 200)
    obj.alchemy_pos_y = get_mod_setting_number("blankStone.alchemy_pos_y", 70)
